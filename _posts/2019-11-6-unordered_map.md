...
<br/>关联容器的特点：元素之间有映射关系，读取、查找效率很高。</br>
...
> <br/>I 可以放在 V (5) 和 X (10) 的左边，来表示 4 和 9。</br>
> <br/>X 可以放在 L (50) 和 C (100) 的左边，来表示 40 和 90。</br> 
> <br/>C 可以放在 D (500) 和 M (1000) 的左边，来表示 400 和 900。</br> 
